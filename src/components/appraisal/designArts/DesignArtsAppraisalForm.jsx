/* eslint-disable no-unused-vars, no-undef, react-hooks/preserve-manual-memoization, react-refresh/only-export-components */
...
<PartB sections={PART_B_SECTIONS} SectionTable={SectionTable} sectionTableProps={sectionTableProps} sectionView={sectionView} />
 )}
</>
 );
}
